...
const ExperienceCard = ({ experience }) => (
  ...
  >
    <div>
      <img src={experience.certificateImg} alt="" className="w-full h-ful object-cover rounded-2xl"/>
      <h3 className="text-white text-[24px] font-bold mt-5">{experience.title}</h3>
      <p
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={styles.sectionHeadText}>Professional Journey.</h2>
      </motion.div>
